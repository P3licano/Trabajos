...
![](../../Imágenes/Pasted%20image%2020260109203038.png)


Encontramos 9 puertos abiertos:
### 22 SSH
...
![](../../Imágenes/Pasted%20image%2020260109203053.png)


Al poder entrar en el *smbd* sin autenticarse miramos a ver qué podemos encontrar

![](../../Imágenes/Pasted%20image%2020260109203106.png)
...
![](../../Imágenes/Pasted%20image%2020260109203239.png)


Entramos a la web del puerto 8080 pero no podemos acceder

![](../../Imágenes/Pasted%20image%2020260109203837.png)

Accedemos por el puerto 8081 y parece que nos redirige satisfactoriamente a la web de la captura anterior

![](../../Imágenes/Pasted%20image%2020260109204523.png)


Exploramos un poco la web

![](../../Imágenes/Pasted%20image%2020260109205601.png)


![](../../Imágenes/Pasted%20image%2020260109205733.png)


En la pestaña de "config" encontramos un parámetro que podemos modificar llamado "java.env script"

![](../../Imágenes/Pasted%20image%2020260109205755.png)


Por el momento, se hace *fuzzing* y no se encuentra nada, así como *searchsploit* sin sacar nada de interés


Mirando por internet nos encontramos el siguiente *exploit* el cual podemos poner una *reverse shell* en el parámetro de "java.env"

![](../../Imágenes/Pasted%20image%2020260109212553.png)
...
Ponemos una **reverse shell**

![](../../Imágenes/Pasted%20image%2020260109214823.png)


Decimos que queremos hacer todos los cambios a la vez

![](../../Imágenes/Pasted%20image%2020260109214842.png)


Logramos una *shell*

![](../../Imágenes/Pasted%20image%2020260109214912.png)
